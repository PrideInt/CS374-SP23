...
class MainActivity : AppCompatActivity() {
    ...
    private fun putImageInStorage(storageReference: StorageReference, uri: Uri, key: String?) {
        ...
        storageReference.putFile(uri).addOnSuccessListener(this) { taskSnapshot -> // After the image loads, get a public downloadUrl for the image
        ...
        }.addOnFailureListener(this) { e -> Log.w(TAG, "Image upload task was unsuccessful.", e) }
    }
